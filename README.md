...
<a href="https://apps.apple.com/app/id6779323783"><img src="https://oca.998810.xyz/api/ranks/badge" alt="Orange Cloud App Store rank" height="20" /></a>
...
[Website](https://oca.998810.xyz) · [Privacy](https://oca.998810.xyz/privacy) · [Terms](https://oca.998810.xyz/terms) · [TestFlight (beta)](https://testflight.apple.com/join/ZGhbsphj) · [Telegram](https://t.me/orange_cloud_channel) · [Ko-fi](https://ko-fi.com/chen2he)
...
2. Create your own **Cloudflare OAuth client** and deploy your own callback relay (see [`apps/web/`](apps/web/README.md)) — the official client ID and the `oca.998810.xyz` relay are not available to third-party builds.
...
2. 自建 **Cloudflare OAuth Client** 并部署你自己的回调中转（见 [`apps/web/`](apps/web/README.md)）——官方 Client ID 与 `oca.998810.xyz` 中转不向第三方构建开放。
