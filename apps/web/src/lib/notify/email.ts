...
// 发件域名须先 onboard（CF 控制台已为 oca.998810.xyz 配好）。
...
const FROM = { email: "noreply@oca.998810.xyz", name: "Orange Cloud" } as const;

// 激活码面向中国大陆 direct（sideload）渠道，故下载指向官网 APK。
const SITE = "https://oca.998810.xyz";
...
<div style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;max-width:480px;margin:0 auto;padding:32px 24px;color:#1c1c1e">
  ...
  <p style="margin:0 0 6px;color:#8e8e93;font-size:13px">官网 <a href="${SITE}" style="color:#F48120;text-decoration:none">oca.998810.xyz</a></p>
