...
struct AboutView: View {
    ...
    var body: some View {
        List {
            ...
            // ── 法律 ──
            Section {
                aboutLink(String(localized: "隐私政策"), icon: "doc.text", url: "https://oca.998810.xyz/privacy")
                aboutLink(String(localized: "使用条款"), icon: "doc.plaintext", url: "https://oca.998810.xyz/terms")
            } header: {
                Text("法律")
            } footer: {
